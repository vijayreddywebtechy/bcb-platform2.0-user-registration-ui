...
export async function GET(
    ...
    try {
        ...
        const ibmClientId = process.env.ACCOUNT_LIST_IBM_CLIENT_ID || process.env.NEXT_PUBLIC_IBM_CLIENT_ID;
        const ibmClientSecret = process.env.ACCOUNT_LIST_IBM_CLIENT_SECRET;
        const clientCertificate = process.env.ACCOUNT_LIST_CLIENT_CERTIFICATE;
