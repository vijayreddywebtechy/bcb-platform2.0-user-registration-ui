...
function BusinessApprovalStatus({ onDone }: BusinessApprovalStatusProps) {
  ...
  return (
    <div className="w-full lg:max-w-[640px]">
      ...
      {/* Heading */}
      <h1 className="text-xl md:text-2xl font-bold text-secondary mb-2">Approval Status</h1>
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-6 items-center">
                  <span className="text-xs text-secondary w-32 shrink-0">Approval Status</span>
