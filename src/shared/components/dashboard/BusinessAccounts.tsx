...
export function BusinessAccountsContent({
  onAccountSelect,
}: {
  ...
  const filteredAccounts = accounts.filter((account) => {
    ...
    const matchesType =
      selectedAccountType?.value === "all" || account.accountType === selectedAccountType?.value;
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 mb-10 bg-neutral-50 p-4 md:p-6 rounded-lg">
        ...
        <div className="md:col-span-4">
          <SearchBox placeholder="Search accounts" value={searchQuery} onChange={setSearchQuery} />
        </div>
                  ...
                  >
                    <div className="flex items-center gap-4 w-[35%]">
                      ...
                      <div className="min-w-0">
                        <h4 className="text-sm md:text-base font-medium text-secondary mb-1">
                          {account.name}
                        </h4>
                    ...
                    <div className="flex items-center w-[65%]">
                      ...
                      <div className="w-[37.5%] pl-8 border-l border-gray-200 flex items-center justify-between">
                        ...
                        <button
                          type="button"
                          className="p-1 opacity-0 hover:bg-blue-100 group-hover:opacity-100 transition-opacity ml-4 rounded-md"
                          onClick={(e) => {
                            e.stopPropagation();
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {currentAccounts.map((account) => (
                ...
                >
                  ...
                  {/* Account info */}
                  <h4 className="text-sm md:text-base font-semibold text-secondary mb-1">
                    {account.name}
                  </h4>
...
function BusinessAccounts({}: Props) {
  ...
  return (
    <Card>
      ...
      />
      <CardBody>
        <BusinessAccountsContent onAccountSelect={() => router.push("/accounts")} />
      </CardBody>
    </Card>
  );
}
