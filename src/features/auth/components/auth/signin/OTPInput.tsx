    ...
    <AuthLayout>
      <AuthCard className="max-w-lg mx-auto w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {errorMessage && (
            <div className="mb-4 p-3 rounded bg-red-50 text-red-700 border border-red-200 text-sm font-medium">
              {errorMessage}
            </div>
          )}
          ...
          <Button type="submit" className="w-full md:!mt-12" disabled={isLoading}>
