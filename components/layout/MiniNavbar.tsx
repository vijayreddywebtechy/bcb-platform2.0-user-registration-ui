...
const navLinkClass =
  "relative flex items-center self-stretch gap-2 text-white text-xs px-1 hover:text-gray-200 transition-colors " +
    ...
    <nav className="w-full bg-primary-deep h-10 flex items-stretch">
      <div className="page-container flex items-stretch justify-between gap-6">
        ...
        <div className="flex items-stretch gap-4">
          ...
          {/* Country Flag */}
          <button type="button" className="flex items-center self-stretch px-1">
