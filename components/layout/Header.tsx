          ...
          {navItems.map((item) => {
            ...
            return (
              <div key={item.label} className="relative flex items-stretch">
                <button
                  onClick={() => (hasDropdown ? toggleDropdown(item.label) : undefined)}
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <Image
                        ...
                        width={20}
                        height={20}
                        className="brightness-0 opacity-100"
                      />
                      <div>
                        <p
                          className={`text-sm font-normal ${profile.active ? "text-primary-dark" : "text-primary-dark"}`}
                        >
                          {profile.name}
                        </p>
