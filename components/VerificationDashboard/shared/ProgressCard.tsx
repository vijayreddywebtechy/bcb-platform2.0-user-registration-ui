                ...
                <div className="bg-neutral-100 p-4 border-b border-neutral-200">
                    <div className="flex items-start justify-between mb-3">
                        <div>
                            ...
                            <h2 className="text-sm font-medium text-neutral-900 my-2">
                                {title}
                            </h2>
                        ...
                        >
                            <ChevronDown
                                className={`w-6 h-6 text-secondary transition-transform ${showSteps ? "rotate-180" : ""
                                    }`}
                            />
                        </button>
                    </div>
                    ...
                    {showSteps && (
                        <div>
                            {steps.map((step, index) => (
                                <div
                                    key={index}
                                    className={`flex items-center justify-between gap-3 py-2.5 px-4 ${step.status === "active" ? "bg-neutral-100" : ""
                                        }`}
                                >
                                    <p
